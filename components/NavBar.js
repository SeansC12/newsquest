...
function NavBar({ user }) {
  ...
  return (
    <div
      className={
        "sticky z-50 top-0 bg-[#0e141b] text-white border-b-[1px] mb-4 border-b-gray-800 h-16 w-full"
      }
    >
      {/* <a href="/">
      ...
      >
        ...
        {isUserMenuOpen ? (
          <div
            className="absolute right-0 top-12 z-10 mt-2 w-48 origin-top-right rounded-md bg-white overflow-hidden shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
            role="menu"
          ...
          >
            <a
              href="/profile"
              className="block px-4 pb-2 pt-3 text-sm text-gray-700 hover:bg-slate-200"
              role="menuitem"
              tabindex="-1"
              id="user-menu-item-0"
            >
            ...
            <div
              ...
              className="cursor-pointer block px-4 pt-2 pb-3 text-sm text-red-500 hover:bg-red-200"
              role="menuitem"
              tabindex="-1"
              id="user-menu-item-2"
            >
