    ...
    <>
      ...
      <div className="flex items-center justify-start flex-col w-[100vw] h-[100vh]">
        <div className="px-10 flex justify-center items-center text-black">
          <div className="flex gap-5 items-center justify-center">
            <img
              ...
              className="rounded-full w-24 aspect-square border-black border-2"
            />
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                className="text-black w-full rounded-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 px-4 py-2"
              ></input>
            </div>
          </div>
        </div>
        <button
          ...
          className={`mt-10 py-2 px-3 ${
            changesMade
              ? "bg-red-500"
              : "bg-slate-400 pointer-events-none"
          } text-white w-fit text-sm font-semibold rounded-md shadow focus:outline-none`}
        >
          Save changes
        </button>
      </div>
